...
let deckOfCards = document.querySelector("#deck-of-cards")
let buttons = document.querySelector(".buttons")
let drawOneBtn = document.querySelector("#draw-card")
let drawFiveBtn = document.querySelector("#pick-five")
...
// set the 'src' attribute of the img use // setAttribute() 
function getCard(){
  randomCard = CARDS[Math.floor(Math.random() * CARDS.length)] 
  newImg = document.createElement("img") 
  newImg.setAttribute("src", randomCard.images.png)
  deckOfCards.append(newImg)
  suitValue = document.createElement("div")
  suitValue.innerHTML = `Suit: ${randomCard.suit} | Value: ${randomCard.value}`
  deckOfCards.append(suitValue)
  pointsDiv = document.createElement("div")
  pointsDiv.setAttribute("id", "points-div")
  pointsDiv.textContent = `Points: ${randomCard.value}`
  inner.appendChild(pointsDiv)
  console.dir(pointsDiv)
}

drawOneBtn.addEventListener("click", getCard)
...
drawFiveBtn.addEventListener("click",drawFive)
...
//"converting JACK-ACE into numstring"
...
for (let i = 0; i<CARDS.length; i++){
  Number(CARDS[i].value)
}


inner.append(searchBar)

function searchValue(){
  for(let i =0; i<CARDS.length; i++){
  if(Number(searchBar.value) <= CARDS[i].value){
    searchImg = document.createElement("img")
    searchImg.src = CARDS[i].image
    deckOfCards.append(searchImg)
...
// if(searchBar.value === CARDS.value){
//   let searchImg = document.createElement("img")
//   searchImg.src = CARDS.image
//   console.log(CARDS.code)
//   deckOfCards.append(searchImg)

// }

showAllBtn.addEventListener("click", searchValue)
...
// if (whatITyped === CARDS.randomCard.value){
//     console.log(deckOfCards.append(CARDS.randomCard.imgs.png))
// }
...
let nintendoBtn = document.querySelector("h3") 

function resetAll(){
 deckOfCards.innerHTML = ""
console.log(inner.childNodes)
let something = inner.querySelectorAll("#points-div")
console.log(something)
for(let e of something){
  e.remove()
}
}
...
nintendoBtn.addEventListener("click", resetAll)